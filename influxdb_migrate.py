...
class MigrationHelper(object):
    ...
    def _migrate(self, measurement, tenant_id, limit, time_offset, target_db_prefix):
        total_written = 0
        target_db = "{}_{}".format(target_db_prefix, tenant_id)
...
if __name__ == "__main__":
    ...
    helper.migrate(start_time_offset=1543511354640000000,
